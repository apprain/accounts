...
{
	public function rpad($input='', $pad_length=0, $pad_string=' ')
	{
		return str_pad ($input, $pad_length, $pad_string, STR_PAD_RIGHT);
	}
	
	public function lpad($input='', $pad_length=0, $pad_string=' ')
	{
		return str_pad ($input, $pad_length, $pad_string, STR_PAD_LEFT);
	}
	
	public function cpad($input='', $pad_length=0, $pad_string=' ')
	{
